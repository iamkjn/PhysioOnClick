  ...
  String _friendlyFirebaseError(FirebaseAuthException e) {
    switch (e.code) {
      case 'email-already-in-use':
        return 'That email is already linked to an account. Try signing in instead.';
      case 'invalid-email':
      ...
      case 'operation-not-allowed':
        return 'Email sign-up is not enabled. Please use Google or Apple.';
      default:
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Join PhysioOnClick to book sessions, track your rehab and manage your health.',
                ...
                const _Divider(label: 'or create with email'),
                const SizedBox(height: 28),
