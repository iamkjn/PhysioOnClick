...
type Chip = { emoji: string; label: string; onTap: () => void };
...
export function ChatWidget() {
  ...
  function homeChips(): Chip[] {
    return [
      { emoji: "🏃", label: "Our services", onTap: tapServices },
      { emoji: "💰", label: "Pricing", onTap: tapPricing },
      { emoji: "📅", label: "Book appointment", onTap: tapBook },
      { emoji: "📍", label: "Location", onTap: tapLocation },
      { emoji: "📞", label: "Contact us", onTap: tapContact },
      { emoji: "❌", label: "Cancellation policy", onTap: tapCancellation },
    ];
  }

  function backChips(): Chip[] {
    return [
      { emoji: "📅", label: "Book appointment", onTap: tapBook },
      { emoji: "🏠", label: "Main menu", onTap: tapHome },
    ];
  }
    ...
    addBot(
      ...
      [
        ...SERVICES.map(s => ({
          emoji: s.emoji,
          label: s.label,
          onTap: () => tapServiceDetail(s.label, s.text),
        })),
        { emoji: "↩", label: "Main menu", onTap: tapHome },
      ],
    );
  ...
  function tapServiceDetail(label: string, text: string) {
    addUser(label);
    addBot(text, [
      { emoji: "📅", label: "Book this service", onTap: tapBook },
      { emoji: "💰", label: "See pricing", onTap: tapPricing },
      { emoji: "↩", label: "Back to services", onTap: tapServices },
      { emoji: "🏠", label: "Main menu", onTap: tapHome },
    ]);
  }

  function tapPricing() {
    addBot(PRICING_TEXT, backChips());
  }

  function tapBook() {
    addUser("Book appointment");
  ...
  function tapCancellation() {
    addBot(
      ...
      [
        { emoji: "👤", label: "My appointments", onTap: () => { window.location.href = "/patient/appointments"; } },
        { emoji: "🏠", label: "Main menu", onTap: tapHome },
      ],
    );
  }
