...
const FULL_POINTS = [
  ...
  "Sharp pain, pain that spreads down a limb, or pain that is worse the next morning means stop and get it checked.",
...
const COMPACT_BODY =
  "Build up gradually, expect some mild soreness that settles within a day, and stop if pain is sharp, spreading, or worse the next morning. These are general exercises - book an assessment if you are unsure or not improving.";
