# Condition hubs - clinical review

**For Shivaliba (HCPC-registered physiotherapist).**

Each section below is one future *condition-hub* page for the public exercise
library: a plain-language explanation of the problem, who the staged programme
suits, the programme itself (stages of exercises drawn from the catalogue), the
condition-specific red flags, a rough recovery timeline, guidance on when to
move on a stage, and a short FAQ.

These are **AI-drafted starting points**, written to the same house style as the
exercise write-ups and pending your sign-off. Nothing here is on the production
site. The data lives in `lib/conditions.ts`; `reviewedOn` is a placeholder date
until you have reviewed it.

> **2026-09-09 competitive pass:** all 25 `intro` fields rewritten to full depth
...
- the **red flag** lists - wording, and whether the right things are flagged,
- the **staged programmes** - is each exercise appropriate for that stage of that condition,
- the **recovery timelines** and any specific numbers or percentages,
- anything in **Clinical notes to check** at the foot of a section.

Tick **Approved** per condition, or leave notes on the `Notes:` line.

Total: 25 condition hubs.

---

## rotator-cuff-tendinopathy - Rotator cuff tendinopathy

**Also known as:** rotator cuff tendinitis, rotator cuff related shoulder pain, shoulder impingement
**Body area:** Shoulder  |  **Service:** musculoskeletal-physiotherapy

**SEO title:** Rotator cuff tendinopathy exercises | PhysioOnClick
**SEO description:** A staged exercise programme for rotator cuff tendinopathy from a HCPC-registered physiotherapist - what to do, how to progress, and when to get assessed.
...
- Shoulder External Rotation (Band) `shoulder-external-rotation-band`
- Shoulder Internal Rotation (Band) `shoulder-internal-rotation-band`
- Scapular Retraction (Band Row) `scapular-retraction-band-row`
...
- Push-Up Plus (Wall or Floor) `push-up-plus-wall-or-floor`
- Overhead Press Progression `overhead-press-progression`

### Red flags - see a doctor first if...
...
**Is it worth having a cortisone injection?**
...
**Related condition hubs:** frozen-shoulder, shoulder-impingement

### Clinical notes to check

- Lists 'shoulder impingement' as an AKA while also having a separate `shoulder-impingement` hub. Confirm you are happy with the overlap, or we merge them.
...
**Also known as:** pulled hamstring, hamstring tear, torn hamstring
**Body area:** Sports & return to activity  |  **Service:** musculoskeletal-physiotherapy

**SEO title:** Hamstring strain exercises and rehab | PhysioOnClick
**SEO description:** A staged rehab programme for a hamstring strain from a HCPC-registered physiotherapist - settle it, rebuild strength, and clear return-to-play markers.
...
- Marching on the Spot `marching-on-the-spot`
...
- Bridge Progression `bridge-progression`
- Single Leg Balance `single-leg-balance`
- Standing Hamstring Stretch `standing-hamstring-stretch`

**Stage 3: Power and change of direction**
...
- Nordic Hamstring Curl (Assisted) `nordic-hamstring-curl-assisted`
- Backward Walking `backward-walking`
- Single Leg Stance with Arm Reach `single-leg-stance-with-arm-reach`
...
- Return-to-Sport Readiness Circuit `return-to-sport-readiness-circuit`
- Nordic Hamstring Curl (Assisted) `nordic-hamstring-curl-assisted`
- Single Leg Stance with Arm Reach `single-leg-stance-with-arm-reach`
...
**Related condition hubs:** return-to-running, return-to-sport-readiness

### Clinical notes to check

- `nordic-hamstring-curl-assisted` is catalogued as *Return to function*; it is introduced here in stage 3 (Power and change of direction). Confirm that timing.
...
**Also known as:** non-specific low back pain, lumbago, back ache
**Body area:** Back & neck  |  **Service:** musculoskeletal-physiotherapy

**SEO title:** Low back pain exercises | PhysioOnClick
**SEO description:** A staged exercise programme for low back pain from a HCPC-registered physiotherapist - settle a flare, rebuild strength, and get back to normal activity.
...
- Segmental Rolling `segmental-rolling`
- Pelvic Tilt `pelvic-tilt`
- Cat-Cow Stretch `cat-cow-stretch`
- Relaxation and Breathing for Pain Management `relaxation-and-breathing-for-pain-management`
...
- Quadruped Arm/Leg Reach `quadruped-arm-leg-reach`
- Functional Lifting Pattern `functional-lifting-pattern`
- Graded Exposure to Feared Movement `graded-exposure-to-feared-movement`
...
**Related condition hubs:** sciatica, return-to-running

### Clinical notes to check

- Red flags include cauda equina symptoms with an A&E instruction. Please check the wording is appropriately urgent but not alarmist.
...
**Also known as:** lumbar radiculopathy, nerve root pain, leg pain from the back
**Body area:** Back & neck  |  **Service:** musculoskeletal-physiotherapy

**SEO title:** Sciatica exercises | PhysioOnClick
**SEO description:** A staged exercise programme for sciatica from a HCPC-registered physiotherapist - nerve glides, strengthening, and how to know when to seek urgent help.
...
- McKenzie Press-Up `mckenzie-press-up`
- Pelvic Tilt `pelvic-tilt`
...
- Bird Dog `bird-dog`
- Bridge Progression `bridge-progression`
- Standing Extension `standing-extension`
...
- Functional Lifting Pattern `functional-lifting-pattern`
- Graded Walking Programme `graded-walking-programme`
- Graded Exposure to Feared Movement `graded-exposure-to-feared-movement`
...
**Should I avoid bending and sitting completely?**
...
**Is the tingling and numbness a bad sign?**
...
**Related condition hubs:** low-back-pain, gluteal-tendinopathy

### Clinical notes to check

- Uses 'centralisation' as the progression guide. Confirm that is the message you want for a lay audience.
...
**Also known as:** non-specific neck pain, mechanical neck pain, text neck, wry neck
**Body area:** Back & neck  |  **Service:** musculoskeletal-physiotherapy

**SEO title:** Neck pain exercises | PhysioOnClick
**SEO description:** A staged exercise programme for everyday neck pain from a HCPC-registered physiotherapist - ease stiffness, build strength, and settle desk-related aches.
...
- Neck Rotation Range `neck-rotation-range`
- Neck Side Flexion Stretch `neck-side-flexion-stretch`
- Chin Tuck `chin-tuck`
...
- Standing Chin Retraction `standing-chin-retraction`
- Scapular Retraction (Band Row) `scapular-retraction-band-row`
...
- Thoracic Rotation (Open Book) `thoracic-rotation-open-book`
- Prone Y-T-W Raises `prone-y-t-w-raises`
...
**Related condition hubs:** shoulder-impingement, rotator-cuff-tendinopathy
...
**Also known as:** adhesive capsulitis, shoulder contracture
**Body area:** Shoulder  |  **Service:** musculoskeletal-physiotherapy

**SEO title:** Frozen shoulder exercises | PhysioOnClick
**SEO description:** A staged exercise programme for frozen shoulder from a HCPC-registered physiotherapist - how to manage the painful phase, restore range, and rebuild strength.
...
**Stage 1: Settle and keep it moving**
...
- Pendulum with Light Weight `pendulum-with-light-weight`
- Scapular Setting `scapular-setting`
- Shoulder Flexion `shoulder-flexion`

**Stage 2: Restore range**
...
**Stage 3: Build strength and return to activity**
...
**Related condition hubs:** rotator-cuff-tendinopathy, shoulder-impingement
...
**Also known as:** subacromial pain syndrome, subacromial impingement, swimmer's shoulder
**Body area:** Shoulder  |  **Service:** musculoskeletal-physiotherapy

**SEO title:** Shoulder impingement exercises | PhysioOnClick
**SEO description:** A staged exercise programme for shoulder impingement from a HCPC-registered physiotherapist - calm the pain, strengthen the cuff, and get back overhead.
...
**Related condition hubs:** rotator-cuff-tendinopathy, frozen-shoulder
...
**Also known as:** lateral epicondylalgia, lateral epicondylitis, extensor tendinopathy
**Body area:** Elbow & wrist  |  **Service:** musculoskeletal-physiotherapy

**SEO title:** Tennis elbow exercises | PhysioOnClick
**SEO description:** A staged exercise programme for tennis elbow from a HCPC-registered physiotherapist - load the tendon safely, manage grip pain, and return to work and sport.
...
- Eccentric Wrist Extension `eccentric-wrist-extension`
- Grip Strengthening `grip-strengthening`
- Scapular Retraction (Band Row) `scapular-retraction-band-row`
...
- Weight-Bearing Through Extended Wrist `weight-bearing-through-extended-wrist`
- Eccentric Wrist Extension `eccentric-wrist-extension`
- Wrist Extensor Stretch `wrist-extensor-stretch`
...
**Related condition hubs:** golfers-elbow, rotator-cuff-tendinopathy
...
**Also known as:** medial epicondylalgia, medial epicondylitis, flexor tendinopathy
**Body area:** Elbow & wrist  |  **Service:** musculoskeletal-physiotherapy

**SEO title:** Golfer's elbow exercises | PhysioOnClick
**SEO description:** A staged exercise programme for golfer's elbow from a HCPC-registered physiotherapist - settle inner-elbow pain, load the tendon, and return to activity.
...
**Related condition hubs:** tennis-elbow, rotator-cuff-tendinopathy

### Clinical notes to check

- The catalogue has no dedicated wrist-*flexor* eccentric-loading exercise for medial epicondylalgia. The strength stage uses `grip-strengthening` plus the flexor stretch as a proxy. A specific eccentric/isotonic wrist-flexion loading exercise would be the ideal addition (flagged for Task 1 follow-up).
...
**Also known as:** knee arthritis, degenerative knee, wear and tear knee
**Body area:** Knee  |  **Service:** musculoskeletal-physiotherapy

**SEO title:** Knee osteoarthritis exercises | PhysioOnClick
**SEO description:** A staged exercise programme for knee osteoarthritis from a HCPC-registered physiotherapist - reduce pain, build strength, and stay active for longer.
...
- Terminal Knee Extension (Band) `terminal-knee-extension-band`
- Step-Up `step-up`
- Hip Bridge `hip-bridge`
...
- Sit-to-Stand Repetitions `sit-to-stand-repetitions`
- Deep Squat Mobility `deep-squat-mobility`
- Graded Walking Programme `graded-walking-programme`
...
**Related condition hubs:** patellofemoral-pain, after-knee-replacement
...
**Also known as:** anterior knee pain, runner's knee, kneecap pain, patellofemoral pain syndrome
**Body area:** Knee  |  **Service:** musculoskeletal-physiotherapy

**SEO title:** Patellofemoral pain exercises | PhysioOnClick
**SEO description:** A staged exercise programme for patellofemoral pain from a HCPC-registered physiotherapist - settle kneecap pain, build strength, and return to running.
...
**Why does sitting for a long time make it ache?**
...
**Related condition hubs:** knee-osteoarthritis, patellar-tendinopathy
...
**Also known as:** greater trochanteric pain syndrome, hip bursitis, lateral hip pain
**Body area:** Hip  |  **Service:** musculoskeletal-physiotherapy

**SEO title:** Gluteal tendinopathy exercises | PhysioOnClick
**SEO description:** A staged exercise programme for gluteal tendinopathy from a HCPC-registered physiotherapist - take the compression off, load the tendon, and sleep better.
...
- Clam Shell `clam-shell`
- Hip Bridge `hip-bridge`
- Standing Hip Flexor Stretch `standing-hip-flexor-stretch`
...
**Should I stretch my outer hip and IT band?**
...
**Related condition hubs:** knee-osteoarthritis, low-back-pain

### Clinical notes to check

- `clam-shell` is used in the settle stage. Some clinicians avoid early clams in irritable gluteal tendinopathy because of adduction/compression. Please confirm it belongs in stage 1 or should move to stage 2.
...
**Also known as:** Achilles tendinitis, Achilles tendinosis, heel cord pain
**Body area:** Ankle & foot  |  **Service:** musculoskeletal-physiotherapy

**SEO title:** Achilles tendinopathy exercises | PhysioOnClick
**SEO description:** A staged exercise programme for Achilles tendinopathy from a HCPC-registered physiotherapist - load the tendon safely and rebuild your running tolerance.
...
- Ankle Pump `ankle-pump`
- Calf Stretch (Gastrocnemius) `calf-stretch-gastrocnemius`
...
**Related condition hubs:** ankle-sprain, return-to-running

### Clinical notes to check

- Pain-monitoring guidance uses a 'up to 3-5/10, settled within 24h, no extra morning stiffness' model. Confirm the threshold.
...
**Also known as:** rolled ankle, twisted ankle, lateral ligament sprain
**Body area:** Ankle & foot  |  **Service:** musculoskeletal-physiotherapy

**SEO title:** Ankle sprain exercises | PhysioOnClick
**SEO description:** A staged exercise programme for a sprained ankle from a HCPC-registered physiotherapist - early movement, balance retraining, and a safe return to sport.
...
- Heel Raises `heel-raises`
- Resisted Ankle Eversion `resisted-ankle-eversion`
- Single Leg Balance `single-leg-balance`
...
- Single Leg Balance on Foam `single-leg-balance-on-foam`
- Uneven Surface Walking `uneven-surface-walking`
- Return-to-Sport Readiness Circuit `return-to-sport-readiness-circuit`
...
**Related condition hubs:** chronic-ankle-instability, achilles-tendinopathy
...
**Also known as:** recurrent ankle sprains, unstable ankle, functional ankle instability
**Body area:** Sports & return to activity  |  **Service:** musculoskeletal-physiotherapy

**SEO title:** Chronic ankle instability exercises | PhysioOnClick
**SEO description:** A four-stage rehab programme for chronic ankle instability from a HCPC-registered physiotherapist - strength, balance, and the return-to-play markers.
...
**Related condition hubs:** ankle-sprain, return-to-sport-readiness
...
**Also known as:** jumper's knee, patellar tendinitis, patellar tendinosis
**Body area:** Sports & return to activity  |  **Service:** musculoskeletal-physiotherapy

**SEO title:** Patellar tendinopathy exercises | PhysioOnClick
**SEO description:** A staged rehab programme for patellar tendinopathy, or jumper's knee, from a HCPC-registered physiotherapist - progressive loading and return-to-play tests.
...
**Do stretching and foam rolling help?**
...
**Related condition hubs:** patellofemoral-pain, return-to-sport-readiness

### Clinical notes to check

- Uses the single-leg decline squat pain scale (<=3/10) and heavy-slow-resistance model. Confirm.
- States corticosteroid injection is generally avoided for the patellar tendon - confirm wording.

- [ ] **Approved** &nbsp;&nbsp; Notes:

---

## acl-rehabilitation - ACL injury rehabilitation

**Also known as:** ACL tear rehab, anterior cruciate ligament rehab, ACL non-surgical rehab
**Body area:** Sports & return to activity  |  **Service:** musculoskeletal-physiotherapy

**SEO title:** ACL injury rehabilitation exercises | PhysioOnClick
**SEO description:** A staged rehab programme after an ACL injury from a HCPC-registered physiotherapist - rebuild quad strength, restore control, and meet return-to-sport tests.
...
**Related condition hubs:** after-acl-reconstruction, return-to-sport-readiness

### Clinical notes to check

- This hub is framed as non-surgical / pre-surgical ACL rehab. `after-acl-reconstruction` is the separate post-op hub. Confirm the split is how you want it presented.
- Return-to-play markers quote 90% limb-symmetry thresholds and a 9-12 month timeline - please sanity-check against your current practice.
...
**Also known as:** getting back to running, run-walk return, return to running after injury
**Body area:** Sports & return to activity  |  **Service:** online-rehab-programmes

**SEO title:** Return to running programme | PhysioOnClick
**SEO description:** A staged return-to-running plan from a HCPC-registered physiotherapist - build the strength base, progress a run-walk plan, and clear the readiness markers.
...
- Treadmill or Level Ground Gait Practice `treadmill-or-level-ground-gait-practice`
- Return-to-Sport Readiness Circuit `return-to-sport-readiness-circuit`
- Heel Raises `heel-raises`
...
**How do I start a run-walk plan?**
...
**How much can I increase each week?**
...
**Should it be completely pain-free?**
...
**I had a baby recently - when can I run?**
...
**Related condition hubs:** achilles-tendinopathy, patellofemoral-pain

- [ ] **Approved** &nbsp;&nbsp; Notes:

---

## return-to-sport-readiness - Return to sport readiness

**Also known as:** return to sport testing, return to play criteria, sport readiness assessment
**Body area:** Sports & return to activity  |  **Service:** musculoskeletal-physiotherapy

**SEO title:** Return to sport readiness programme | PhysioOnClick
**SEO description:** A four-stage return-to-sport readiness programme from a HCPC-registered physiotherapist - bridge the gap between finishing rehab and competing again.
...
- General Mobility Warm-Up `general-mobility-warm-up`
- Single Leg Balance `single-leg-balance`
- Hip Bridge `hip-bridge`
...
**Related condition hubs:** acl-rehabilitation, hamstring-strain

- [ ] **Approved** &nbsp;&nbsp; Notes:

---

## after-knee-replacement - After a knee replacement

**Also known as:** total knee replacement rehab, knee arthroplasty recovery, TKR rehab
**Body area:** Post-surgical  |  **Service:** post-surgical-rehabilitation

**SEO title:** Exercises after a knee replacement | PhysioOnClick
**SEO description:** A staged exercise programme after a knee replacement from a HCPC-registered physiotherapist - restore movement, rebuild strength, and return to normal life.
...
- Ankle Pumps (Post-Surgery) `ankle-pumps-post-surgery`
- Quad Sets `quad-sets`
- Heel Slide `heel-slide`
- Straight Leg Raise `straight-leg-raise`
...
- Sit to Stand Control `sit-to-stand-control`
- Stationary Bike `stationary-bike`
- Mini Squat `mini-squat`
...
- Step-Up `step-up`
- Stair Negotiation Practice `stair-negotiation-practice`
- Post-Op Walking Programme `post-op-walking-programme`
- Return-to-Function Strength Circuit `return-to-function-strength-circuit`
...
**Related condition hubs:** knee-osteoarthritis, falls-prevention

- [ ] **Approved** &nbsp;&nbsp; Notes:

---

## after-hip-replacement - After a hip replacement

**Also known as:** total hip replacement rehab, hip arthroplasty recovery, THR rehab
**Body area:** Post-surgical  |  **Service:** post-surgical-rehabilitation

**SEO title:** Exercises after a hip replacement | PhysioOnClick
**SEO description:** A staged exercise programme after a hip replacement from a HCPC-registered physiotherapist - restore movement, rebuild strength, and walk confidently again.
...
- Ankle Pumps (Post-Surgery) `ankle-pumps-post-surgery`
- Hip Abduction in Lying (Post-Op) `hip-abduction-in-lying-post-op`
- Supported Standing (Post-Hip) `supported-standing-post-hip`
...
**Related condition hubs:** after-knee-replacement, falls-prevention

- [ ] **Approved** &nbsp;&nbsp; Notes:

---

## after-acl-reconstruction - After an ACL reconstruction

**Also known as:** ACL surgery rehab, ACL graft rehab, post-operative ACL rehabilitation
**Body area:** Post-surgical  |  **Service:** post-surgical-rehabilitation

**SEO title:** Exercises after an ACL reconstruction | PhysioOnClick
**SEO description:** A staged rehab plan after ACL reconstruction from a HCPC-registered physiotherapist - protect the graft, rebuild strength, and meet return-to-sport tests.
...
- Resisted Knee Extension (Post-ACL) `resisted-knee-extension-post-acl`
- Mini Squat `mini-squat`
- Terminal Knee Extension (Band) `terminal-knee-extension-band`
- Stationary Bike `stationary-bike`

**Stage 3: Power and control**
...
**Related condition hubs:** acl-rehabilitation, return-to-sport-readiness

### Clinical notes to check

- Timelines (crutches 1-3 weeks, jog at 3-4 months, RTS 9-12 months) and 90% symmetry criteria are generic - confirm or adjust.
- The programme repeatedly defers to 'your surgeon's protocol'. Confirm that framing is right for a public page.
...
**Also known as:** balance training for older adults, fear of falling, reducing falls risk
**Body area:** Older adults  |  **Service:** gait-and-mobility-assessment

**SEO title:** Falls prevention exercises for older adults | PhysioOnClick
**SEO description:** A staged balance and strength programme to reduce falls risk from a HCPC-registered physiotherapist - build steadiness, leg strength, and confidence.
...
- Standing on One Leg (Hand Support) `standing-on-one-leg-hand-support`
- Static Standing Balance (Eyes Open) `static-standing-balance-eyes-open`
- Marching on the Spot `marching-on-the-spot`
- Sit-to-Stand Repetitions `sit-to-stand-repetitions`

**Stage 2: Build strength and balance**
...
- Single Leg Balance `single-leg-balance`
- Tandem Balance Hold `tandem-balance-hold`
- Heel-to-Toe Walking (Tandem Gait) `heel-to-toe-walking-tandem-gait`
- Heel Raises `heel-raises`
- Sit-to-Stand Repetitions `sit-to-stand-repetitions`

**Stage 3: Return to confident activity**
...
- Turning Practice `turning-practice`
- Obstacle Stepping `obstacle-stepping`
- Dual-Task Walking `dual-task-walking`
- Uneven Surface Walking `uneven-surface-walking`
...
**Is it safe to do balance exercises if I have already fallen?**
...
**I am scared of falling during the exercises - what should I do?**
...
**Related condition hubs:** after-hip-replacement, after-knee-replacement

### Clinical notes to check

- Quotes the '3 hours/week of balance-challenging exercise, sustained 6+ months' evidence figure (Sherrington et al. / NICE). Confirm.
...
**Also known as:** bladder leakage, leaking when coughing or exercising, pelvic floor weakness
**Body area:** Women's health  |  **Service:** online-rehab-programmes

**SEO title:** Stress urinary incontinence exercises | PhysioOnClick
**SEO description:** A staged pelvic floor programme for stress urinary incontinence from a HCPC-registered physiotherapist - the right technique, then strength and impact.
...
- Diaphragmatic Breathing for Pelvic Floor `diaphragmatic-breathing-for-pelvic-floor`
- Pelvic Floor Activation (Basic) `pelvic-floor-activation-basic`
...
- Pelvic Floor Endurance Hold `pelvic-floor-endurance-hold`
- Fast-Twitch Pelvic Floor 'The Knack' `fast-twitch-pelvic-floor-the-knack`
- Deep Core and Pelvic Floor Co-Activation `deep-core-and-pelvic-floor-co-activation`
...
- Bridge with Pelvic Floor Engagement `bridge-with-pelvic-floor-engagement`
- Squat with Pelvic Floor Control `squat-with-pelvic-floor-control`
- Return-to-Running Pelvic Floor Check `return-to-running-pelvic-floor-check`
...
**Should I stop drinking so much to reduce leaks?**
...
**Related condition hubs:** pregnancy-pelvic-girdle-pain, return-to-running

### Clinical notes to check

- No women's-health service exists in `lib/site-data.ts`; `serviceSlug` is set to `online-rehab-programmes` as the nearest fit. Confirm that signposting, or whether it should be left blank until a pelvic-health service page exists.
- `return-to-running-pelvic-floor-check` is catalogued as *postnatal return to running* - included here for the impact/return stage. Confirm it is acceptable for a general (non-postnatal) SUI hub.

- [ ] **Approved** &nbsp;&nbsp; Notes:

---

## pregnancy-pelvic-girdle-pain - Pregnancy-related pelvic girdle pain

**Also known as:** PGP, symphysis pubis dysfunction, SPD, pelvic pain in pregnancy
**Body area:** Women's health  |  **Service:** online-rehab-programmes

**SEO title:** Pelvic girdle pain in pregnancy exercises | PhysioOnClick
**SEO description:** A staged exercise programme for pelvic girdle pain in pregnancy from a HCPC-registered physiotherapist - ease the pain, support the pelvis, and stay mobile.
...
- Standing Pelvic Tilt (Pregnancy) `standing-pelvic-tilt-pregnancy`
- Pelvic Tilt `pelvic-tilt`
- Diaphragmatic Breathing for Pelvic Floor `diaphragmatic-breathing-for-pelvic-floor`

**Stage 2: Build support**
...
- Side-Lying Hip Abduction (Pregnancy-Safe) `side-lying-hip-abduction-pregnancy-safe`
- Clam Shell `clam-shell`
- Hip Bridge `hip-bridge`
- Pelvic Floor Activation (Basic) `pelvic-floor-activation-basic`

**Stage 3: Manage daily life**
...
**Is my pelvis unstable or damaged?**
...
**Will it affect my labour and birth?**
...
**Related condition hubs:** stress-urinary-incontinence, low-back-pain

### Clinical notes to check

- Same service-slug question as SUI - set to `online-rehab-programmes`.
- `clam-shell` (not the pregnancy-safe abduction variant) is included in the build-support stage alongside `side-lying-hip-abduction-pregnancy-safe`. Confirm the plain clam is fine in pregnancy or should be dropped.
