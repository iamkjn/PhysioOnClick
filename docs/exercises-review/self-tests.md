# Self-Check Tests - Draft Content for Clinical Review
...
## This is the medico-legal review gate

Nothing in this file reaches a patient-facing page in production until you tick
**Approved** on that test. Every `positiveResult`, `negativeResult`, `interpretation`
and `whoShouldNotDoThis` line needs your explicit sign-off. Please give particular
attention to:

- **`whoShouldNotDoThis`** - is the contraindication / red-flag list complete and safe
  for a member of the public with no clinician present? Flag anything missing.
- **`interpretation`** - it must stay hedged ("may point towards ... only a hands-on
  assessment can tell you for sure") and never assert a diagnosis. Tell us if any line
  drifts towards "this means you have X".
- **`positiveResult` / `negativeResult`** - are these the right, safe lay descriptions
  of a positive and negative response? Over-calling a positive sends worried people to
  book; under-calling a positive gives false reassurance. Both matter.
- **Test selection** - is each test appropriate to hand to the public unsupervised, and
  is it mapped to the right condition hub(s)?

`reviewedBy` is set to "Shivaliba Zala" and `reviewedOn` to 2026-09-08 as a shared
placeholder (same as the condition hubs) - it does **not** indicate your sign-off yet.
...
- **Slug:** `full-can-test`
- **Also known as:** "full can", "supraspinatus test", "Jobe test"
- **Assesses:** The supraspinatus, one of the four rotator cuff muscles
- **Body area:** Shoulder
- **Points towards (condition hubs):** `rotator-cuff-tendinopathy`, `shoulder-impingement`
...
1. **Stand tall with your arm by your side**  _(image: `test-full-can-1`)_
  - Stand or sit upright with your shoulders relaxed and level.
  - Keep your elbow straight but not locked.
2. **Lift the arm to shoulder height, out and slightly forward**  _(image: `test-full-can-2`)_
...
3. **Turn the thumb up towards the ceiling**  _(image: `test-full-can-3`)_
  - Rotate the whole arm so your thumb points up, as if holding a full can of drink you do not want to spill.
4. **Press the arm up gently against light resistance**  _(image: `test-full-can-4`)_
...
- **Also known as:** "hawkins kennedy", "hawkins test"
- **Assesses:** Whether the rotator cuff tendons are being pinched under the shoulder blade
- **Body area:** Shoulder
- **Points towards (condition hubs):** `shoulder-impingement`, `rotator-cuff-tendinopathy`
- **Reviewed by / on:** Shivaliba Zala / 2026-09-08 _(shared placeholder - not your sign-off)_
...
4. **Note where and when the pain appears**  _(image: `test-hawkins-kennedy-4`)_
...
---
## 3. Painful Arc Self-Check

- **Slug:** `painful-arc-self-check`
- **Also known as:** "painful arc", "arc of pain"
- **Assesses:** Where in the range of lifting the arm out to the side the shoulder is irritable
- **Body area:** Shoulder
- **Points towards (condition hubs):** `shoulder-impingement`, `rotator-cuff-tendinopathy`
- **Reviewed by / on:** Shivaliba Zala / 2026-09-08 _(shared placeholder - not your sign-off)_
...
1. **Stand with both arms by your sides**  _(image: `test-painful-arc-1`)_
  - Stand tall with your thumbs pointing forwards.
  - Relax your shoulders down.
2. **Slowly raise the sore arm out to the side**  _(image: `test-painful-arc-2`)_
  - Lift the arm sideways towards overhead at a slow, steady pace.
  - Keep the thumb pointing up and the elbow straight.
3. **Note the range where it hurts**  _(image: `test-painful-arc-3`)_
...
4. **Compare with the other arm**  _(image: `test-painful-arc-4`)_
...
---
## 4. Resisted Wrist Extension Test

- **Slug:** `resisted-wrist-extension-test`
- **Also known as:** "Cozen's test self-version", "tennis elbow test"
- **Assesses:** The wrist and finger extensor tendons that attach on the outer elbow
- **Body area:** Elbow & wrist
- **Points towards (condition hubs):** `tennis-elbow`
- **Reviewed by / on:** Shivaliba Zala / 2026-09-08 _(shared placeholder - not your sign-off)_
...
1. **Straighten the arm out in front of you**  _(image: `test-wrist-ext-1`)_
  - Hold the arm out with the elbow straight and the palm facing down.
  - Make a loose fist.
2. **Cock the wrist up towards the ceiling**  _(image: `test-wrist-ext-2`)_
  - Bend the wrist back so the knuckles lift towards the ceiling.
  - Keep the elbow straight.
3. **Press down on the back of the hand with your other hand**  _(image: `test-wrist-ext-3`)_
...
4. **Note where any pain appears**  _(image: `test-wrist-ext-4`)_
...
- **Also known as:** "golfer's elbow test", "medial epicondyle test"
- **Assesses:** The wrist flexor tendons that attach on the inner elbow
- **Body area:** Elbow & wrist
- **Points towards (condition hubs):** `golfers-elbow`
- **Reviewed by / on:** Shivaliba Zala / 2026-09-08 _(shared placeholder - not your sign-off)_
...
1. **Straighten the arm with the palm facing up**  _(image: `test-wrist-flex-1`)_
  - Hold the arm out in front with the elbow straight and the palm facing up.
  - Open the hand.
2. **Curl the wrist up towards you**  _(image: `test-wrist-flex-2`)_
  - Bend the wrist so the palm lifts towards your face.
  - Keep the elbow straight.
3. **Press the hand back down with your other hand**  _(image: `test-wrist-flex-3`)_
  - Use your other hand to push the palm back down while you resist.
  - Light to moderate effort only, held for about 5 seconds.
4. **Note where any pain appears**  _(image: `test-wrist-flex-4`)_
...
- **Also known as:** "slump test", "seated nerve glide test"
- **Assesses:** Whether the sciatic nerve is sensitive to being put on stretch
- **Body area:** Back & neck
- **Points towards (condition hubs):** `sciatica`
- **Reviewed by / on:** Shivaliba Zala / 2026-09-08 _(shared placeholder - not your sign-off)_
...
- **Also known as:** "SLR test", "Lasegue self-check"
- **Assesses:** Whether lifting the straight leg reproduces leg pain from a sensitised sciatic nerve
- **Body area:** Back & neck
- **Points towards (condition hubs):** `sciatica`, `low-back-pain`
- **Reviewed by / on:** Shivaliba Zala / 2026-09-08 _(shared placeholder - not your sign-off)_
...
1. **Lie flat on your back**  _(image: `test-slr-1`)_
  - Lie on a bed or the floor with both legs straight and relaxed.
  - Rest your head down.
2. **Slowly lift one straight leg**  _(image: `test-slr-2`)_
...
3. **Note the height and the symptoms**  _(image: `test-slr-3`)_
...
4. **Lower the leg and compare with the other side**  _(image: `test-slr-4`)_
...
- **Assesses:** How well the knee tolerates load through the kneecap tendon and the front of the knee
- **Body area:** Knee
- **Points towards (condition hubs):** `patellofemoral-pain`, `patellar-tendinopathy`
- **Reviewed by / on:** Shivaliba Zala / 2026-09-08 _(shared placeholder - not your sign-off)_
...
1. **Set up on a small slope**  _(image: `test-decline-squat-1`)_
...
2. **Stand on the leg you want to test**  _(image: `test-decline-squat-2`)_
  - Shift your weight onto the test leg and lift the other foot just off the ground.
  - Keep your trunk upright.
3. **Slowly bend the knee to about a quarter squat**  _(image: `test-decline-squat-3`)_
...
4. **Come back up and note the response**  _(image: `test-decline-squat-4`)_
...
- **Body area:** Hip
- **Points towards (condition hubs):** `gluteal-tendinopathy`
- **Reviewed by / on:** Shivaliba Zala / 2026-09-08 _(shared placeholder - not your sign-off)_
...
1. **Stand facing a mirror**  _(image: `test-trendelenburg-1`)_
...
2. **Lift one foot to stand on the test leg**  _(image: `test-trendelenburg-2`)_
  - Bend the other knee and lift that foot a few centimetres off the floor.
  - Do not hitch or push off - just lift it clear.
3. **Hold for up to 30 seconds and watch your pelvis**  _(image: `test-trendelenburg-3`)_
...
4. **Note any hip pain and compare sides**  _(image: `test-trendelenburg-4`)_
...
- **Body area:** Ankle & foot
- **Points towards (condition hubs):** `achilles-tendinopathy`, `ankle-sprain`
- **Reviewed by / on:** Shivaliba Zala / 2026-09-08 _(shared placeholder - not your sign-off)_
...
1. **Stand next to a wall for balance**  _(image: `test-calf-raise-1`)_
...
2. **Rise up onto the ball of your foot**  _(image: `test-calf-raise-2`)_
...
3. **Lower under control and repeat**  _(image: `test-calf-raise-3`)_
  - Lower slowly all the way down.
  - Repeat at a steady pace, about one rise every two seconds, going as high each time.
4. **Count to fatigue and compare sides**  _(image: `test-calf-raise-4`)_
...
- **Body area:** Sports & return to activity
- **Points towards (condition hubs):** `hamstring-strain`
- **Reviewed by / on:** Shivaliba Zala / 2026-09-08 _(shared placeholder - not your sign-off)_
...
1. **Lie on your back in a doorway**  _(image: `test-ake-1`)_
...
4. **Note how far it goes and where you feel it, then compare**  _(image: `test-ake-4`)_
