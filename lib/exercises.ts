...
export const exercises: Exercise[] = [
  ...
  // ex-162 (banded-neck-isometrics) removed pre-publication - duplicated ex-23 isometric-neck-hold
  {
    id: "ex-163",
  ...
  },
  {
    ...
    helpsWith: ["Strengthening the deeper calf muscle used in running", "Building the deeper calf muscle that a straight-knee raise misses", "Coping with longer walks and runs"]
  },
  {
    id: "ex-166",
    slug: "spanish-squat",
